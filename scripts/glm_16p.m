...
opt.test.mean_del.group.contrast.FD_scrubbed_both_norm = 0;
...
opt.test.mean_dup.group.contrast.FD_scrubbed_both_norm = 0;
...
opt.test.del_minus_dup.group.contrast.FD_scrubbed_both_norm = 0;
...
opt.test.del_minus_con.group.contrast.FD_scrubbed_both_norm = 0;
...
opt.test.dup_minus_con.group.contrast.FD_scrubbed_both_norm = 0;
